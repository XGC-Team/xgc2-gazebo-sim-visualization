...
Depends: ros-noetic-gazebo-msgs, ros-noetic-geometry-msgs, ros-noetic-mavros-msgs, ros-noetic-robot-state-publisher, ros-noetic-roscpp, ros-noetic-roslaunch, ros-noetic-rviz, ros-noetic-std-msgs, ros-noetic-tf2-ros, ros-noetic-visualization-msgs, ros-noetic-xgc2-robot-visualization (>= 0.1.0-3)
